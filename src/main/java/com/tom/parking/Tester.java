...
public class Tester {
    public static void main(String[] args) {
        ...
        LocalDateTime leave =
                LocalDateTime.of(2018,12,25,
                        10,8,0);
//        Car car = new Car("AA-0001",enter.atZone(ZoneId.systemDefault()).toEpochSecond());//.currentTimeMillis(),得到一個long值
...
//        java();
    ...
    private static void java8() {
        ...
        LocalDateTime other =
                LocalDateTime.of(2019,02,12,16,02);
    ...
    private static void java() {
        ...
        String s = "2019/02/12 08:00:00";
        Date other = null;
        try {
             other = sdf.parse(s);
            System.out.println(other);//可把此行提出
        } catch (ParseException e) {
            e.printStackTrace();
        }
//        宣告Date other = null; 可在外面列印出來
//        System.out.println(other);
